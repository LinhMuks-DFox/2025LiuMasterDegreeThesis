\begin{abstract}
    ...
    Furthermore, we conduct a comprehensive interpretability analysis, revealing that the encoder spontaneously organizes acoustic events based on temporal structures (continuity vs. intermittency) and preserves topological invariance under noise injection.
\end{abstract}
