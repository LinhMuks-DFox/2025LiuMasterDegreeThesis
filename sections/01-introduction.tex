...
However, the blinky remains constrained by severe bandwidth limitations imposed by the camera's frame rate, which is typically 30 frames per second (FPS), as well as by noise introduced during light-signal transmission through the air.
